...
const createPredictionEvent = (state) => {
  console.log(state);
}
  ...
  return (
    <>
      ...
      <Box margin={["medium", 0, 0, 0]}>
        ...
        <Input label="Target Price" type="number" value={state.targetPrice} name="targetPrice" onChange={evt => dispatch({ target: evt.target.name, value: evt.target.value })} />
